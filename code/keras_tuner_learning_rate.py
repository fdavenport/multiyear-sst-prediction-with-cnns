...
def model_builder(hp):
    ...
    learning_rate = hp.Float("learning_rate", min_value = 1e-7, max_value = 1e-2,
                             sampling = "log")
...
tuner = kt.RandomSearch(
    ...
    overwrite=False, 
    directory="../processed_data/kt_results/kt_lr",
...
tensorboard_callback = tf.keras.callbacks.TensorBoard(
    log_dir='../processed_data/kt_logs/kt_lr/kt_60mo_'+args.model+'_'+str(args.lat)+'_'+str(args.lon))
