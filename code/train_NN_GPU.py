...
parser.add_argument('--GPU', type=int, default=0) ## which GPU to run on
...
# this line will print information about the selected GPU:
...
output_dir = "/GPU-scratch/fvdav22/multiyear_prediction/processed_data/training/"+args.y_var+"_"+str(args.prediction_length)+\
